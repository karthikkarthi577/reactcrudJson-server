  ...
  return (
    <div>
      <section className="w-full  mt-[100px]    ">
        <h1 className="text-center text-2xl font-semibold mt-6 text-red-500 ">CREATE</h1>
        <article className="w-[50%] mx-auto flex justify-center bg-slate-400 shadow-2xl  py-24 rounded-sm mt-2 " >
          <div>
